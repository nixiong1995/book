                ...
                if($sex==1){
                    ...
                    if($type==1){
                        ...
                        foreach ( $SellingBooks as $sellingBook) {
                            $result['data']['selling'][] = ['book_id' => $sellingBook->id, 'name' => $sellingBook->name,
                        ...
                        foreach (  $NewBooks as $newBook) {
                            $result['data']['new'][] = ['book_id' => $newBook->id, 'name' => $newBook->name,
                        ...
                        foreach ( $UpdateBooks as $updateBook) {
                            $result['data']['new'][] = ['book_id' => $updateBook->id, 'name' => $updateBook->name,
