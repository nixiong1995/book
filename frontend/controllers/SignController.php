...
class SignController extends Controller
{
    ...
    public function actionSign()
    {
       ...
       /* $get4=new PostRequest();
        $content=$get4->send_request('http://chapterup.zhuishushenqi.com/chapter/http%3a%2f%2fbook.my716.com%2fgetBooks.aspx%3fmethod%3dcontent%26bookId%3d1228859%26chapterFile%3dU_1228859_201712201239352394_5685_826.txt',
            [
                'view'=>'summary',
                'book'=>1,
            ]);
        $contents=json_decode($content);
        var_dump($contents->chapter->body);exit;
        foreach ($contents->chapter as $content){
            var_dump($content);
        }*/
        $model1=new Book();
        $model1->name='西游记';
